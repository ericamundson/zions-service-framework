...
SET rm.include.phases=requirements,audit
SET rm.mapping.file=.\mapping\CoreRRMMapping.xml
SET rm.filter=allFilter
SET rm.tfs.areapath=BaNCS\Requirements\R2
SET rm.sql.resource=sql/coreR2.sql
...
SET log.dng=%logdir%\translate_DNGtoADO_full.log
