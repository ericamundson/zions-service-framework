...
(  T1.REQUIREMENT_TYPE NOT IN ( 'Formal Use Case (Text)','Technical Design Requirement','Change Request','Actor','Use Case','User Story','Spec Proxy','Function Point','Process Inventory','Term','Use Case Diagram' ) AND
