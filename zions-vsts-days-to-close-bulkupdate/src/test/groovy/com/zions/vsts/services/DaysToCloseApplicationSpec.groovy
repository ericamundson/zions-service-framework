...
@ContextConfiguration(classes=[DaysToCloseApplicationTestConfig])
class DaysToCloseApplicationSpec extends Specification {
...
class DaysToCloseApplicationTestConfig {
	@Bean
	IGenericRestClient genericRestClient() {
