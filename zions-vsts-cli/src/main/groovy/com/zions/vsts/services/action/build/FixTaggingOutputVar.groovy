...
@Component
class FixTaggingOutputVar implements CliAction {
	BuildManagementService buildManagementService
	ProjectManagementService projectManagementService
	
	@Autowired
	public FixTaggingOutputVar(BuildManagementService buildService, ProjectManagementService projectManagementService) {
	...
	public def execute(ApplicationArguments data) {
		...
		if (buildId != null && buildId != "") {
			...
			def result = buildManagementService.updateTaggingTask(collection, projectData, buildId, newOutputVarName)
		} else {
