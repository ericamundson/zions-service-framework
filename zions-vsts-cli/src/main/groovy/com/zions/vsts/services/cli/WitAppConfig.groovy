...
@Configuration
@Profile("wit")
@ComponentScan(["com.zions.common.services.excel,com.zions.vsts.services.work.templates,com.zions.vsts.services.action.wit,com.zions.vsts.services.admin.project"])
public class AppConfigWit {
