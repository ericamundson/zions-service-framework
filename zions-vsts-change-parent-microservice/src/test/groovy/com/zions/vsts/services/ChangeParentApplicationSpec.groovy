...
@ContextConfiguration(classes=[ChangeParentApplicationSpecConfig])
class ChangeParentApplicationSpec extends Specification {
...
class ChangeParentApplicationSpecConfig {
	@Bean
	IGenericRestClient genericRestClient() {
